...
print("\nTest Case 1:")
print("Input: [5.1, 3.5, 1.4, 0.2]")
print("Predicted Class:", pred1[0])
print("Probabilities:", prob1[0])
...
print("\nTest Case 2:")
print("Input: [6.0, 2.7, 5.1, 1.6]")
print("Predicted Class:", pred2[0])
print("Probabilities:", prob2[0])
...
print("\nTest Case 3:")
print("Input: [6.3, 3.3, 6.0, 2.5]")
print("Predicted Class:", pred3[0])
print("Probabilities:", prob3[0])
